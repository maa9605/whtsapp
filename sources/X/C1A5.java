...
public class C1A5 {
    ...
    public static boolean A00(PackageInfo packageInfo, boolean z) {
        ...
        return z ? A01(packageInfo, A02, A03) : A01(packageInfo, A02);
    }
    ...
    public final boolean A02() {
        ...
        try {
            packageInfo = C06080Rl.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
        ...
        if (C0CL.A01(this.A00)) {
            return A00(packageInfo, true);
        }
        boolean A00 = A00(packageInfo, false);
        if (!A00 && A00(packageInfo, true)) {
