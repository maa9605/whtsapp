...
public class C07270Xo implements Cloneable {
    ...
    public C07270Xo(int i) {
        if (i == 0) {
            this.A02 = AnonymousClass030.A00;
            this.A03 = AnonymousClass030.A02;
            return;
        }
        int i2 = i << 2;
        int i3 = 4;
    ...
    /* renamed from: A01 */
    public C07270Xo clone() {
        try {
            C07270Xo c07270Xo = (C07270Xo) super.clone();
            c07270Xo.A02 = (int[]) this.A02.clone();
            c07270Xo.A03 = (Object[]) this.A03.clone();
            return c07270Xo;
    ...
    public Object A02(int i, Object obj) {
        Object obj2;
        int A00 = AnonymousClass030.A00(this.A02, this.A00, i);
        return (A00 < 0 || (obj2 = this.A03[A00]) == A04) ? obj : obj2;
    }
    ...
    public void A05(int i, Object obj) {
        ...
        int i2 = this.A00;
        int i3 = i2;
        int A00 = AnonymousClass030.A00(iArr, i2, i);
        if (A00 >= 0) {
            this.A03[A00] = obj;
            return;
        }
        ...
        if (this.A01 && i2 >= iArr.length) {
            A03();
            i3 = this.A00;
            i4 = AnonymousClass030.A00(iArr, i3, i) ^ (-1);
        }
        int length = iArr.length;
        if (i3 >= length) {
            int i5 = (i3 + 1) << 2;
