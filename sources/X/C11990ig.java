...
public class C11990ig extends Drawable {
    public static InterfaceC11980if A0G;
    ...
    public C11990ig(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
    ...
    public final void A01(float f, float f2) {
        if (f < 0.0f) {
            ...
            this.A02 = f3;
            this.A01 = f4;
            this.A03 = (int) ((f3 * 1.5f) + this.A0C + 0.5f);
            this.A0A = true;
            invalidateSelf();
        } else {
    ...
    public void draw(Canvas canvas) {
        if (this.A0A) {
            ...
            float f = this.A01;
            float f2 = 1.5f * f;
            this.A0F.set(bounds.left + f, bounds.top + f2, bounds.right - f, bounds.bottom - f2);
            float f3 = this.A00;
            float f4 = -f3;
        ...
        float f12 = (this.A02 / 2.0f) + f10 + this.A0C;
        RectF rectF3 = this.A0F;
        float f13 = f12 * 2.0f;
        boolean z = rectF3.width() - f13 > 0.0f;
        boolean z2 = rectF3.height() - f13 > 0.0f;
        ...
        canvas.translate(0.0f, (-this.A02) / 2.0f);
        A0G.A7U(canvas, rectF3, this.A00, this.A07);
    }
