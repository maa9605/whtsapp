...
public final class C32381dw extends C08G {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: X.19q
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            C07K.A1G(parcel, A09);
            return new C32381dw(i, parcelFileDescriptor);
        }

        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ Object[] newArray(int i) {
            return new C32381dw[i];
        }
    };
    public final int A00;
    public final ParcelFileDescriptor A01;

    public C32381dw(int i, ParcelFileDescriptor parcelFileDescriptor) {
        this.A00 = i;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        AnonymousClass088.A1L(parcel, 3, this.A01, i | 1, false);
