...
public class C08770c2 extends C08780c3 {
    ...
    public C08770c2(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.A07 = true;
        this.A06 = true;
        this.A08 = false;
        this.A0B = C02160Ac.A00(context, R.color.design_fab_shadow_start_color);
        this.A0A = C02160Ac.A00(context, R.color.design_fab_shadow_mid_color);
        this.A09 = C02160Ac.A00(context, R.color.design_fab_shadow_end_color);
    ...
    public void draw(Canvas canvas) {
        ...
        float f11 = f9 * 2.0f;
        boolean z2 = rectF4.width() - f11 > 0.0f;
    ...
    public boolean getPadding(Rect rect) {
        ...
        float f3 = 1.5f * f;
        if (z) {
            f3 = (float) (((1.0d - A0F) * f2) + f3);
        }
        int ceil = (int) Math.ceil(f3);
        if (z) {
            f = (float) (((1.0d - A0F) * f2) + f);
        }
