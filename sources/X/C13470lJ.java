...
public class C13470lJ extends InputStream implements DataInput {
    public int A00;
    ...
    public C13470lJ(InputStream inputStream) {
    ...
    public int readInt() {
        ...
        if (i <= this.A03) {
            ...
            if ((read | read2 | read3 | read4) >= 0) {
                ...
                StringBuilder A0P = C000200d.A0P("Invalid byte order: ");
                A0P.append(byteOrder);
