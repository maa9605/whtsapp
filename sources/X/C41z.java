...
public class C41z implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public C41z() {
        ...
        if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
            ...
            if (EGL14.eglChooseConfig(this.A0D, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0) && (eGLConfig = eGLConfigArr[0]) != null) {
                ...
                StringBuilder A0P = C000200d.A0P("eglCreateContext: EGL error: 0x");
                A0P.append(Integer.toHexString(eglGetError));
    ...
    public static int A00(int i, String str) {
        ...
        if (iArr[0] == 0) {
            ...
            A0P.append(GLES20.glGetShaderInfoLog(glCreateShader));
            Log.e("GLSurfacePipe", A0P.toString());
    ...
    public static void A01(int i, String str) {
        if (i < 0) {
            throw new RuntimeException(C000200d.A0I("Unable to locate '", str, "' in program"));
        }
    }
    ...
    public static void A02(String str) {
        ...
        StringBuilder A0V2 = C000200d.A0V(str, ": glError 0x");
        A0V2.append(Integer.toHexString(glGetError));
