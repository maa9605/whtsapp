...
public final class C32361du extends C08G {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: X.19o
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            C07K.A1G(parcel, A09);
            return new C32361du(i, arrayList);
        }

        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ Object[] newArray(int i) {
            return new C32361du[i];
        }
    };
    public final int A00;
    public final List A01;

    public C32361du(int i, List list) {
        this.A00 = i;
        this.A01 = list;
    }
