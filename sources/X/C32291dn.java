...
public final class C32291dn extends C08G {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: X.19g
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            C07K.A1G(parcel, A09);
            return new C32291dn(i, parcelFileDescriptor);
        }

        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ Object[] newArray(int i) {
            return new C32291dn[i];
        }
    };
    public final int A00;
    public final ParcelFileDescriptor A01;

    public C32291dn(int i, ParcelFileDescriptor parcelFileDescriptor) {
        this.A00 = i;
