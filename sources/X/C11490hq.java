...
public class C11490hq {
    ...
    public static int A00(Context context, int i) {
        ...
        return C09990f7.A03(A012, Math.round(Color.alpha(A012) * f));
    }
    ...
    public static ColorStateList A02(Context context, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, iArr);
        try {
            if (!obtainStyledAttributes.hasValue(0) || (resourceId = obtainStyledAttributes.getResourceId(0, 0)) == 0 || (colorStateList = C09L.A00(context, resourceId)) == null) {
