...
public final class C31961dE extends C08G {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: X.18r
        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ Object[] newArray(int i) {
            return new C31961dE[i];
        }
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            C07K.A1G(parcel, A09);
            return new C31961dE(i, z);
        }
    };
    public final int A00;
    public final boolean A01;

    public C31961dE(int i, boolean z) {
        this.A00 = i;
        this.A01 = z;
    }
