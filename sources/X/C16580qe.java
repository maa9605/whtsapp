...
public class C16580qe {
    public static final String A00 = AbstractC16430qO.A01("WrkDbPathHelper");
        ...
        if (Build.VERSION.SDK_INT >= 23 && databasePath.exists()) {
            ...
            for (File file3 : hashMap.keySet()) {
                ...
                if (file3.exists() && file4 != null) {
                    if (file4.exists()) {
                        AbstractC16430qO.A00().A05(str, String.format("Over-writing contents of %s", file4), new Throwable[0]);
                    }
                    ...
                    AbstractC16430qO.A00().A02(str, format, new Throwable[0]);
                }
            }
        }
    }
