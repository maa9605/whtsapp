...
public class C08010aS {
    ...
    public C08010aS(TextView textView) {
        this.A09 = textView;
    ...
    public static Object A00(Object obj, String str, Object obj2) {
        try {
            obj2 = A01(str).invoke(obj, new Object[0]);
            return obj2;
        } catch (Exception e) {
    ...
    public void A03() {
        ...
        if ((!(textView instanceof C04850Mb)) && this.A03 != 0) {
            if (this.A06) {
                ...
                int measuredWidth = booleanValue ? 1048576 : (textView.getMeasuredWidth() - textView.getTotalPaddingLeft()) - textView.getTotalPaddingRight();
    ...
    public final boolean A06() {
        if ((!(this.A09 instanceof C04850Mb)) && this.A03 == 1) {
