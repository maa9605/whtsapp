...
public final class C32311dp extends C08G {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: X.19i
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            C07K.A1G(parcel, A09);
            return new C32311dp(i, z);
        }

        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ Object[] newArray(int i) {
            return new C32311dp[i];
        }
    };
    public final int A00;
    public final boolean A01;

    public C32311dp(int i, boolean z) {
        this.A00 = i;
        this.A01 = z;
    }
