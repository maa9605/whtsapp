...
public final class C222911v {
    ...
    public C222911v(Context context) {
    ...
    public final void A00(Canvas canvas, boolean z) {
        ...
        if (z) {
            ...
            if (staticLayout != null) {
                ...
                canvas.translate(this.A0I, this.A0K);
                if (Color.alpha(this.A0L) > 0) {
                    Paint paint = this.A0Y;
                    paint.setColor(this.A0L);
                    canvas.drawRect(-this.A0J, 0.0f, staticLayout.getWidth() + this.A0J, staticLayout.getHeight(), paint);
                }
                int i3 = this.A0C;
                if (i3 == 1) {
