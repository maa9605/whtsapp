...
public class C885943s {
    public static final Rect A00;
    public static final boolean A01;

    static {
        A01 = Build.VERSION.SDK_INT >= 17;
        A00 = new Rect(-1000, -1000, SearchActionVerificationClientService.CONNECTION_TIMEOUT_IN_MS, SearchActionVerificationClientService.CONNECTION_TIMEOUT_IN_MS);
    }

    public static C885743q A00(Camera.Parameters parameters, String str, String str2) {
        ...
        return new C885743q(str, str3, i, sparseArray, arrayList);
    }
    ...
    */
    public static java.util.ArrayList A03(java.lang.String r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C885943s.A03(java.lang.String):java.util.ArrayList");
    }
    ...
    public static List A05(List list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            arrayList.add(new C42C(size2.width, size2.height));
        }
        return arrayList;
    }
