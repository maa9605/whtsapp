...
public class C50262Ra extends ImageSpan {
    public WeakReference A00;

    public C50262Ra(Drawable drawable) {
        super(drawable);
    }
    ...
    public static void A02(SpannableStringBuilder spannableStringBuilder, Drawable drawable, Paint paint, int i, int i2, int i3) {
        ...
        spannableStringBuilder.setSpan(new C50262Ra(drawable), i2, i3, 33);
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        canvas.translate(f, (((fontMetrics.ascent + fontMetrics.descent) - bounds.height()) / 2.0f) + i4);
        A03.draw(canvas);
        canvas.restore();
    }
}
