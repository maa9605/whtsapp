...
public final class C32481e7 extends C08G {
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() { // from class: X.1A0
        ...
        public final Object createFromParcel(Parcel parcel) {
            ...
            C07K.A1G(parcel, A09);
            return new C32481e7(i, c32251dj);
        }

        @Override // android.os.Parcelable.Creator
        public final /* synthetic */ Object[] newArray(int i) {
            return new C32481e7[i];
        }
    };
    public final int A00;
    public final C32251dj A01;

    public C32481e7(int i, C32251dj c32251dj) {
        this.A00 = i;
        this.A01 = c32251dj;
    }
