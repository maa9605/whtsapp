...
public abstract class Hilt_StatusPlaybackBaseFragment extends StatusPlaybackFragment {
    ...
    @Override // com.whatsapp.status.playback.fragment.Hilt_StatusPlaybackFragment, X.C0BA
    public Context A0a() {
        return this.A00;
    }
    ...
    */
    public void A0c(android.app.Activity r4) {
        ...
        L27:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.status.playback.fragment.Hilt_StatusPlaybackBaseFragment.A0c(android.app.Activity):void");
    }
    ...
    public void A0u(Context context) {
        super.A0u(context);
        if (this.A00 == null) {
            this.A00 = new C52902bX(((Hilt_StatusPlaybackFragment) this).A00, this);
            A0x();
        }
    }
}
