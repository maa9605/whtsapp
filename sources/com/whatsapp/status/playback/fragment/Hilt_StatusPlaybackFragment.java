...
public abstract class Hilt_StatusPlaybackFragment extends WaFragment implements AnonymousClass005 {
    ...
    public void A0x() {
        if (!(this instanceof Hilt_StatusPlaybackContactFragment)) {
            ...
            this.A01 = true;
            ((C0CS) generatedComponent()).A2q((StatusPlaybackFragment) this);
            return;
        }
        ...
        ((C0CS) hilt_StatusPlaybackContactFragment.generatedComponent()).A2p((StatusPlaybackContactFragment) hilt_StatusPlaybackContactFragment);
    }
