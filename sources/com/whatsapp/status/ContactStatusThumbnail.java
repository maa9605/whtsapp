...
public class ContactStatusThumbnail extends C2Z7 {
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public ContactStatusThumbnail(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C08540bf.A0o);
            this.A01 = obtainStyledAttributes.getInteger(1, 0);
            this.A03 = obtainStyledAttributes.getInteger(2, 0);
            obtainStyledAttributes.recycle();
        }
        this.A00 = C02160Ac.A00(context, R.color.contactStatusThumbnailRingBackground);
    }
