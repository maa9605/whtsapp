...
public class SettingsJidNotificationActivity extends C2PK {
    @Override // X.C2PK, X.C0WC, X.C0WD, X.ActivityC06980Vx, X.AbstractActivityC06990Vy, X.ActivityC02310Ar, X.ActivityC02320As, X.ActivityC02330At, X.ActivityC02340Au, X.ActivityC02350Av, android.app.Activity
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView(R.layout.preference_activity);
        if (bundle == null) {
            ((ActivityC06980Vx) this).A06 = new SettingsJidNotificationFragment();
