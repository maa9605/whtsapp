...
public abstract class Hilt_GalleryFragmentBase extends WaFragment implements AnonymousClass005 {
    ...
    public void A0x() {
        if (this instanceof Hilt_ProductGalleryFragment) {
            ...
            ((C0CS) hilt_ProductGalleryFragment.generatedComponent()).A1b((ProductGalleryFragment) hilt_ProductGalleryFragment);
        } else if (this instanceof Hilt_LinksGalleryFragment) {
            ...
            ((C0CS) hilt_LinksGalleryFragment.generatedComponent()).A1Y((LinksGalleryFragment) hilt_LinksGalleryFragment);
        } else if (!(this instanceof Hilt_DocumentsGalleryFragment)) {
            if (this.A01) {
                return;
            }
            this.A01 = true;
            ((C0CS) generatedComponent()).A1X((GalleryFragmentBase) this);
        } else {
            ...
            ((C0CS) hilt_DocumentsGalleryFragment.generatedComponent()).A1W((DocumentsGalleryFragment) hilt_DocumentsGalleryFragment);
        }
    }
