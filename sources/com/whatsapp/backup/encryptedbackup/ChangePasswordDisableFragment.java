...
public class ChangePasswordDisableFragment extends Hilt_ChangePasswordDisableFragment {
    ...
    public void A0w(View view, Bundle bundle) {
        ...
        C0AT.A0D(view, R.id.enc_backup_change_password_button).setOnClickListener(new AbstractView$OnClickListenerC49532Ky() { // from class: X.1kA
            @Override // X.AbstractView$OnClickListenerC49532Ky
            public void A00(View view2) {
                C36281kX c36281kX2 = c36281kX;
                c36281kX2.A04.A0B(4);
                c36281kX2.A06(201);
            }
        });
        C0AT.A0D(view, R.id.enc_backup_disable_button).setOnClickListener(new AbstractView$OnClickListenerC49532Ky() { // from class: X.1kB
            @Override // X.AbstractView$OnClickListenerC49532Ky
            public void A00(View view2) {
                C36281kX c36281kX2 = c36281kX;
                c36281kX2.A04.A0B(3);
