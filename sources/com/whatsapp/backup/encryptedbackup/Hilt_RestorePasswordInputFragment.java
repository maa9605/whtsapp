...
public abstract class Hilt_RestorePasswordInputFragment extends PasswordInputFragment {
     ...
     */
    @Override // com.whatsapp.backup.encryptedbackup.Hilt_PasswordInputFragment, X.C0BA
    /*
    ...
    */
    public void A0c(android.app.Activity r4) {
        ...
        L27:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.backup.encryptedbackup.Hilt_RestorePasswordInputFragment.A0c(android.app.Activity):void");
    }
    ...
    public void A0u(Context context) {
        super.A0u(context);
        if (this.A00 == null) {
            this.A00 = new C52902bX(((Hilt_PasswordInputFragment) this).A00, this);
            A0x();
        }
    }
    ...
    public void A0x() {
        ...
        this.A01 = true;
        ((C0CS) generatedComponent()).A0b((RestorePasswordInputFragment) this);
    }
}
