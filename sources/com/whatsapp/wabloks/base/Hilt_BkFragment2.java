...
public abstract class Hilt_BkFragment2 extends WaDialogFragment {
    ...
    */
    public void A0c(android.app.Activity r4) {
        ...
        L27:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.wabloks.base.Hilt_BkFragment2.A0c(android.app.Activity):void");
    }
    ...
    public void A17() {
        if (!(this instanceof Hilt_ShopsProductPreviewFragment)) {
            ...
            this.A01 = true;
            ((C0CS) generatedComponent()).A3S((BkFragment2) this);
            return;
        }
        ...
        ((C0CS) hilt_ShopsProductPreviewFragment.generatedComponent()).A3a((ShopsProductPreviewFragment) hilt_ShopsProductPreviewFragment);
    }
}
