    ...
    */
    public void A0c(android.app.Activity r4) {
        ...
        L27:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.conversation.conversationrow.Hilt_SecurityNotificationDialogFragment.A0c(android.app.Activity):void");
    }
    ...
    public void A17() {
        if (!(this instanceof Hilt_IdentityChangeDialogFragment)) {
            Hilt_DeviceChangeDialogFragment hilt_DeviceChangeDialogFragment = (Hilt_DeviceChangeDialogFragment) this;
            if (!hilt_DeviceChangeDialogFragment.A01) {
                hilt_DeviceChangeDialogFragment.A01 = true;
                ((C0CS) hilt_DeviceChangeDialogFragment.generatedComponent()).A19((DeviceChangeDialogFragment) hilt_DeviceChangeDialogFragment);
                return;
            }
            return;
        }
        Hilt_IdentityChangeDialogFragment hilt_IdentityChangeDialogFragment = (Hilt_IdentityChangeDialogFragment) this;
        if (hilt_IdentityChangeDialogFragment.A01) {
            return;
        }
        hilt_IdentityChangeDialogFragment.A01 = true;
        ((C0CS) hilt_IdentityChangeDialogFragment.generatedComponent()).A1B((IdentityChangeDialogFragment) hilt_IdentityChangeDialogFragment);
    }
}
