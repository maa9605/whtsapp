...
public class BloksCameraOverlay extends View {
    ...
    public void A00(String str) {
        ...
        if (TextUtils.equals(str, "selfie")) {
            ...
            this.A08.addRect(f, f3, i7, i8, direction);
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, 0.0f, this.A07, this.A06, paint);
        canvas.drawRect(0.0f, this.A06, this.A04, this.A02, paint);
        canvas.drawRect(this.A05, this.A06, this.A07, this.A02, paint);
        canvas.drawRect(0.0f, this.A02, this.A07, this.A03, paint);
        paint.setStrokeWidth(this.A00);
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(872415231);
        canvas.drawRect(this.A04, this.A06, this.A05, this.A02, paint);
        if (TextUtils.equals(this.A09, "selfie")) {
