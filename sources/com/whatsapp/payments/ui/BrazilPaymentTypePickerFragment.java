...
public class BrazilPaymentTypePickerFragment extends PaymentTypePickerFragment {
    ...
    private void A00() {
        if (this.A00 == null) {
            this.A00 = new C52902bX(((Hilt_PaymentTypePickerFragment) this).A00, this);
            if (this.A01) {
                return;
            }
            this.A01 = true;
            ((C0CS) generatedComponent()).A24(this);
        }
    }
     ...
     */
    @Override // com.whatsapp.payments.ui.Hilt_PaymentTypePickerFragment, X.C0BA
    /*
    ...
    */
    public void A0c(android.app.Activity r4) {
        ...
        L10:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.payments.ui.BrazilPaymentTypePickerFragment.A0c(android.app.Activity):void");
    }
