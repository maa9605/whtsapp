...
public abstract class Hilt_PaymentInviteFragment extends WaFragment implements AnonymousClass005 {
    ...
    public void A0x() {
        ...
        if (!hilt_IndiaUpiPaymentInviteFragment.A01) {
            ...
            ((C0CS) hilt_IndiaUpiPaymentInviteFragment.generatedComponent()).A2G((IndiaUpiPaymentInviteFragment) hilt_IndiaUpiPaymentInviteFragment);
        }
    }
