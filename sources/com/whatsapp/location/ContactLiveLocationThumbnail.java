...
public class ContactLiveLocationThumbnail extends AbstractC51742Xr {
    public float A00;
    public int A01;
    public int A02;
    public boolean A03;
    ...
    public ContactLiveLocationThumbnail(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C08540bf.A0n);
    ...
    public void A02(Canvas canvas) {
        ...
        if (this.A02 > 1) {
            ...
            this.A05.setColor(-1);
            this.A05.setTextSize(getResources().getDimensionPixelSize(R.dimen.title_text_size));
            canvas.drawText(C000200d.A0K(new StringBuilder(), this.A02, ""), rectF.centerX(), rectF.centerY() - ((this.A05.descent() + this.A05.ascent()) / 2.0f), this.A05);
        }
    }
