...
public abstract class Hilt_StickerStoreTabFragment extends WaFragment implements AnonymousClass005 {
    ...
    public void A0x() {
        if (this instanceof Hilt_StickerStoreMyTabFragment) {
            ...
            ((C0CS) hilt_StickerStoreMyTabFragment.generatedComponent()).A2y((StickerStoreMyTabFragment) hilt_StickerStoreMyTabFragment);
        } else if (!(this instanceof Hilt_StickerStoreFeaturedTabFragment)) {
            if (this.A01) {
                return;
            }
            this.A01 = true;
            ((C0CS) generatedComponent()).A2z((StickerStoreTabFragment) this);
        } else {
            ...
            ((C0CS) hilt_StickerStoreFeaturedTabFragment.generatedComponent()).A2x((StickerStoreFeaturedTabFragment) hilt_StickerStoreFeaturedTabFragment);
        }
    }
