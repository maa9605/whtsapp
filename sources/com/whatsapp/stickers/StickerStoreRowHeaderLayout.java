...
public class StickerStoreRowHeaderLayout extends AbstractC82543qg {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getChildCount() != 4) {
            C000700j.A08(false, "StickerStoreRowHeaderLayout should have 4 children!");
            return;
        }
        ...
        C000700j.A08(false, "StickerStoreRowHeaderLayout should have 4 children! Title View, Animated View, Author View and a Remaining View");
    }
}
