...
public class ChatInfoLayout extends AbstractC49162Iu {
    public float A00;
    public float A01;
    public float A02;
    public int A03;
    ...
    public ChatInfoLayout(Context context, AttributeSet attributeSet) {
        ...
        this.A0Q = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: X.2pB
            {
                ChatInfoLayout.this = this;
            }
    ...
    public void A01() {
        ...
        this.A0G = new C06030Rg(this, (int) R.id.conversation_contact_name, this.A0I, this.A0L);
        AnonymousClass088.A1V(findViewById(R.id.conversation_contact_name), R.string.action_open_image);
        ...
        Display defaultDisplay = C018308n.A00(getContext()).getWindowManager().getDefaultDisplay();
        Point point = new Point();
        defaultDisplay.getSize(point);
        this.A0A.setLayoutParams(new LinearLayout.LayoutParams(-1, Math.min(point.x, point.y)));
        this.A0D.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: X.2p7
            {
                ChatInfoLayout.this = this;
            }
            ...
            public void onGlobalLayout() {
                ...
                if (chatInfoLayout.getWidth() > chatInfoLayout.getHeight()) {
                    ...
                    chatInfoLayout.A0D.setOnScrollListener(new AbsListView.OnScrollListener() { // from class: X.2p8
                        @Override // android.widget.AbsListView.OnScrollListener
                        public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                            ChatInfoLayout.A00(chatInfoLayout);
                        }
                ...
                chatInfoLayout.A0D.setSelectionFromTop(0, measuredWidth);
                chatInfoLayout.setScrollPos(measuredWidth);
                chatInfoLayout.A0D.post(new RunnableC57352pA(chatInfoLayout, measuredWidth));
            }
        });
    }
    ...
    public final void A02() {
        ...
        if (charSequence != null) {
            this.A0A.setContentDescription(AnonymousClass029.A0o(this.A0J, false, Arrays.asList(charSequence.toString(), this.A0O)));
        }
        AnonymousClass088.A1V(this.A0A, R.string.action_open_image);
    }
    ...
    public void A03(int i, int i2) {
        ...
        if (getWidth() < getHeight()) {
            float f = this.A00;
            if (f > 0.0f) {
                C0LX.A06(this.A0J, this.A0C, (int) (this.A04 * f * f), (int) (this.A03 * f * f));
            }
        }
    }

    public void A04(final View view, final View view2, final View view3, final Adapter adapter) {
        this.A0D.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: X.2ox
            {
                ChatInfoLayout.this = this;
            }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.A0A.getVisibility() != 8) {
            ...
            AnonymousClass088.A1V(this.A0B, R.string.action_open_image);
            this.A0B.setClickable(true);
            C06030Rg c06030Rg = this.A0G;
            c06030Rg.A01.setOnClickListener(this.A08);
            this.A0A.setVisibility(8);
            this.A0D.post(new RunnableEBaseShape1S0100000_I0_1(this, 9));
        }
    ...
    public void setPushName(String str) {
        ...
        if (this.A0F != null) {
            ...
            AnonymousClass088.A1V(this.A0F, R.string.action_open_image);
        }
    }
    ...
    public void setScrollPos(int i) {
        if (getWidth() >= getHeight()) {
            ...
            C0LX.A06(this.A0J, this.A0C, 0, 0);
        ...
        if (max < (this.A07 << 1)) {
            ...
            C06030Rg c06030Rg = this.A0G;
            c06030Rg.A01.setEllipsize(TextUtils.TruncateAt.END);
            ...
            this.A0E.setSingleLine(false);
            int i2 = this.A07;
            ((ViewGroup.MarginLayoutParams) this.A0G.A01.getLayoutParams()).setMargins(0, Math.min(i2, max - (i2 << 1)), 0, 0);
            if (this.A0F != null && !TextUtils.isEmpty(this.A0M)) {
                this.A0F.setVisibility(0);
            }
        }
        if (ellipsize != this.A0G.A01.getEllipsize()) {
            C06030Rg c06030Rg2 = this.A0G;
            c06030Rg2.A01.setText(this.A0N);
            A02();
        }
        if (this.A06 == max) {
            return;
    ...
    public void setTitleText(String str) {
        ...
        CharSequence A0F = C002701i.A0F(charSequence, getContext(), this.A0G.A01.getPaint(), 0.9f, null, this.A0K);
        if (A0F != null) {
            charSequence = A0F;
        }
