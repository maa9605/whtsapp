...
public abstract class Hilt_StickerSearchTabFragment extends WaFragment implements AnonymousClass005 {
    ...
    public final void A0x() {
        if (this.A00 == null) {
            ...
            this.A01 = true;
            ((C0CS) generatedComponent()).A2N((StickerSearchTabFragment) this);
        }
    }
